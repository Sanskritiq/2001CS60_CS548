...
def fs(type, feat, label, feat_val, label_val, opts):
    switcher = {
        ...
        'wsa': 'weighted_superposition_attraction',
        # 2016
        'ja': 'jaya_algorithm',
    ...
    model = module.optim(feat, label, feat_val, label_val, opts)  # Replace 'function_name' with the actual function name
    ...
    # Add processing time to the model
    model['t'] = t
